...
dates.list <- list(seq.Date(ymd('2019-01-01'), ymd('2019-08-31'), by='d'),
                   seq.Date(ymd('2020-01-01'), ymd('2020-08-31'), by='d')) 

source(boxpath('BJ PM2.5 datalog/AQscripts/S5P/memory safe mean, focal.R'))
